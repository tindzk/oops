...
class OOPSC {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			CodeStream stream = outFile == null ? new CodeStream()
												: new CodeStream(outFile);
	...
	private static void usage() {
		System.out
				.println("java -jar OOPSC.jar [-c] [-h] [-hs <n>] [-i] [-l] [-s] [-ss <n>] <quelldatei> [<ausgabedatei>]");
		System.out
				.println("    -c       Zeige das Ergebnis der Kontextanalyse");
		...
		System.out
				.println("    -s       Zeige das Ergebnis der syntaktischen Analyse");
		System.out
				.println("    -ss <n>  Reserviere <n> Worte fuer den Stapel (Standard ist 100)");
	}
}