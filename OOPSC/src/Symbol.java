...
class Symbol extends Position {
	...
	enum Id {
		IDENT, NUMBER, BEGIN, END, CLASS, IS, METHOD, READ, WRITE, IF, THEN,
		WHILE, DO, COLON, SEMICOLON, COMMA, PERIOD, LPAREN, RPAREN, EQ, NEQ,
		GT, GTEQ, LT, LTEQ, PLUS, MINUS, TIMES, DIV, MOD, BECOMES, NEW, SELF,
		NULL, TRUE, FALSE, NOT, AND, OR, ELSE, ELSEIF, RETURN, EOF
	}
